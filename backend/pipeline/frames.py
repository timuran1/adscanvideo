...
def get_metadata(video_path: str) -> dict:
    ...
    result = subprocess.run(
        [
            "ffprobe",
            "-v", "quiet", "-protocol_whitelist", "file,crypto,data", "-format_whitelist", "mov,matroska,webm",
            "-print_format", "json",
            "-show_format",
            "-show_streams",
...
def extract(
    ...
    cmd: list[str] = [
        ...
        "-hide_banner",
        "-loglevel", "error",
        "-y", "-threads", "1", "-filter_threads", "1", "-protocol_whitelist", "file,crypto,data", "-format_whitelist", "mov,matroska,webm",
    ]
